        ...
        messages: [{
                ...
                content: {
                    ...
                    text: [
                        ...
                        "",
                        "## Bước 4: Bảo mật",
                        "7. Gọi `check_security_flag` → nếu HIGH/CRITICAL → `security_review_checklist`",
                        "",
                        "## Bước 5: Git + Implement + Commit",
                        "8. `suggest_branch_name` → tạo branch → hỏi user confirm",
                        "9. Implement → hỏi user review code diff",
                        "10. `suggest_commit_message` → commit → hỏi user confirm",
                        "",
                        "---",
