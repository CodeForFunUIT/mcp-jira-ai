...
export function registerResources(server) {
    ...
    server.resource("team-context", "team://context", {
        description: "Tribal knowledge của team: architecture rules, service patterns, " +
    ...
    server.resource("git-standard", "git://standard", {
        description: "Quy chuẩn Git: branch naming, commit message, workflow. " +
    ...
    server.resource("mcp-config", "config://mcp", {
        description: "Cấu hình MCP server: defaults, paths, safety rules, git prefixes.",
